...
const headerInfo = (item) => {
    const blockTop = item.querySelector('.block__top');
    const blockBottom = item.querySelector('.block__bottom');
    blockTop.classList.toggle('block-top_active');
    blockBottom.classList.toggle('block-bottom_active');
}
block.forEach(item => {
